        ...
        {          
            if (LineCheck.Checked == true)
            {
                ...
                {                  
                    ...
                    for (double i = ArrayX.Max() + 1; i < ArrayX.Max() + Convert.ToDouble(PrognosisN.Text); i++)
                    {
                        this.chart1.Series[2].Points.AddXY(i, LineA * i + LineB);
                    }
                }
                catch(Exception ex)
                {
            ...
            if (ParabolaCheck.Checked == true)
            {
                try
                {
                    ...
                    for (double i = ArrayX.Max() + 1; i < ArrayX.Max() + Convert.ToDouble(PrognosisN.Text); i++)
                    {
                        this.chart1.Series[2].Points.AddXY(i, ParabolaA * i + ParabolaB * i + ParabolaC);
                    }                
                }
                catch (Exception ex)
                {
